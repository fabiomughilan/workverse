...
- 🙌 Get latest updates? Follow our [Twitter](https://twitter.com/WorkverseApp).
- 💕 Love this project? Consider [buy me a coffee](https://www.buymeacoffee.com/Workverse).
...
```bash
git clone https://github.com/fabiomughilan/Workverse.git
```

This will create a folder named `Workverse`. You can specify a different folder name like this:

```bash
git clone https://github.com/fabiomughilan/Workverse.git my-folder-name
```
